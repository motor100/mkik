...
// Обновление image в таблице mainnews /upload на public/uploads/
Route::get('/temp/mainnews-update', [MainController::class, 'mainnews_update']);

// Обновление image в таблице afishas /upload на public/uploads/
Route::get('/temp/afishas-update', [MainController::class, 'afishas_update']);

// Обновление image в таблице calendar /upload на public/uploads/
