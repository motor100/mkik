    ...
    <div class="content">
      <div class="container-fluid">
        ...
        <div class="afisha-form mb-5">
          <form class="form" action="/dashboard/svedeniya-ob-obrazovatelnoj-organizacii/obrazovanie-programmy-podgotovki-specialistov-srednego-zvena-update" method="post">
