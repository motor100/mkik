...
<div class="dashboard-home">
    ...
    <div class="content">
      <div class="container-fluid">
        ...
        <form class="form mb-5" action="/dashboard/studentam-grafik-uchebnogo-processa/add" enctype="multipart/form-data" method="post">
        ...
        <div class="archive">
          ...
          @foreach($documents as $doc)
            <div class="item d-flex justify-content-between mb-3">
              ...
              <a class="delete" href="/dashboard/studentam-grafik-uchebnogo-processa/del/{{$doc->id}}">
