...
<div class="dashboard-home">
    ...
    <div class="content">
      <div class="container-fluid">
        ...
        <form class="form mb-5" action="/dashboard/studentam-metodicheskie-rekomendacii/add" enctype="multipart/form-data" method="post">
        ...
        <div class="archive list-archive">
          ...
          @foreach($documents as $doc)
            <div class="item d-flex justify-content-between mb-3">
              ...
              <a class="list-btn delete-btn" href="/dashboard/studentam-metodicheskie-rekomendacii/del/{{$doc->id}}">
