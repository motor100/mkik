    ...
    <div class="content">
      <div class="container-fluid">
        ...
        <div class="form-wrapper mb-5">
          <form class="form" action="/dashboard/prepodavatelyam-makety/add" enctype="multipart/form-data" method="post">

            <div class="form-group mb-3">
              <label for="inputTitle" class="form-check-label">Название документа (150 символов)</label>
              <input type="text" name="title" class="form-control" id="inputTitle" maxlength="150" required>
            </div>
        ...
        <div class="archive list-archive">
          ...
          @foreach($documents as $doc)
            <div class="item d-flex justify-content-between mb-3">
              ...
              <a class="list-btn delete-btn" href="/dashboard/prepodavatelyam-makety/del/{{$doc->id}}">
