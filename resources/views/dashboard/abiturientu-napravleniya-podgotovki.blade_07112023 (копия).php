  ...
  <div class="content">
    <div class="container-fluid">
      ...
      <div class="abiturientu-napravleniya-podgotovki-form mb-5">
        <form class="form" action="/dashboard/abiturientu-napravleniya-podgotovki-update" enctype="multipart/form-data" method="post">
          ...
          <div class="form-group mb-3">
            ...
            <input type="text" name="chairman" class="form-control" id="inputChairman" maxlength="150" value="{{ $abiturientu_napravleniya_podgotovki[0]->chairman }}">
          </div>
          <div class="form-group mb-3">
            ...
            <div id="image-link-wrapper" class="link-wrapper">
              @if($abiturientu_napravleniya_podgotovki[0]->gallery)
                @foreach($abiturientu_napravleniya_podgotovki[0]->gallery as $glr)
          ...
          <div class="form-group mb-3">
            ...
            <input type="text" name="teachers" class="form-control" id="inputTeachers" maxlength="200" value="{{ $abiturientu_napravleniya_podgotovki[0]->teachers }}">
          </div>
          <div class="form-group mb-3">
            <label for="text" class="form-check-label">Описание</label>
            <textarea name="text" id="text">{{ $abiturientu_napravleniya_podgotovki[0]->text }}</textarea>
          </div>
          <div class="form-group mb-5">
            <label for="inputDiploma" class="form-check-label">Диплом</label>
            <input type="text" name="diploma" class="form-control" id="inputDiploma" maxlength="100" value="{{ $abiturientu_napravleniya_podgotovki[0]->diploma }}">
          </div>

          <input type="hidden" name="id" id="inputId" value="{{ $abiturientu_napravleniya_podgotovki[0]->id }}">
      ...
      <div class="hidden-text hidden">
        @foreach($abiturientu_napravleniya_podgotovki as $cnt)
          <div class="item">
